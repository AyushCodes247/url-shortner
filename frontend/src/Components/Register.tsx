...
const Register = () => {
  document.title = "MicroLink | Register.";
      ...
      <main className="flex h-[calc(100vh-64px)] items-center justify-center px-5">
        <div className="w-full max-w-md rounded-3xl border border-zinc-800 bg-zinc-900/90 p-8 shadow-2xl shadow-blue-500/5 backdrop-blur-xl transition-all duration-300 hover:border-zinc-700">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Create your MicroLink account to start shortening URLs.
          </p>
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  className="w-full appearance-none rounded-xl border border-zinc-700 bg-zinc-800 py-3 pl-11 pr-4 text-white outline-none transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30"
                  {...register("gender")}
                >
